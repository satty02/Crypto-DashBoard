...
1) Renamed the folder Name from currency to baseCurrency
2) added two more currencies (japanese yen & euro) => 
    - change symbol for euro  yen currency in sidebar components
    - 
