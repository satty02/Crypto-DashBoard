    ...
    return (
        ...
        <div className="md:mt-3 mx-3 my-2 main-container bg-slate-300 antialiased xl:flex  flex-row max-w-fit h-fit overflow-hidden">
            <div className="flex-row max-w-fit">
                ...
                <div className="flex-grow  sm:h-[27rem] md:h-[23rem] xl:h-[17.5rem] 2xl:h-[37.5rem] sm:w-[39rem] md:w-[62rem] lg:w-[56.5rem] xl:w-[55.5rem] 2xl:w-[83rem] lg:mr-3  bg-white px-3 sm:my-3 xl:my-2 2xl:my-5 ml-5 mr-0 rounded-lg  ">
                    <ChartDataAPI/>
                </div>
            ...
            <div className="xl:mr-5 xl:ml-1 sm:ml-5 2xl:mx-6 my-5 rounded-lg bg-white sm:w-[39rem] md:w-[30rem] lg:w-[22.5rem] xl:w-[23rem] 2xl:w-[30.5rem] xl:h-[37.5rem]  2xl:h-[63rem] overflow-hidden">
                <CoinListAPI/>
            </div>
        </div>
