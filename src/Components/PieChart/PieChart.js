  ...
  return (
    <div className='piechart'>
      <div className='flex pt-3 border-b-2'>
        ...
        <div className='pl-14 2xl:pl-10 text-gray-400' data-testid='value'> Total value: <b className=' ml-2 text-black'>{baseCurrency==='inr'?'₹':baseCurrency==='usd'?'$':baseCurrency==='eur'?'€':baseCurrency==='jpy'?'¥':'No select currency'}{sumMktCap}</b></div>
      </div >
